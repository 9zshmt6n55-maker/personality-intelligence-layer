...
- `society-room-emotion-layers.png` - room atmosphere plus nearby social field plus agent personality.
- `social-emotion-propagation.png` - how verified actions spread emotion as influence, not identity control.
- `pdk-observatory-readonly.png` - observatory as a read-only inspection surface.
